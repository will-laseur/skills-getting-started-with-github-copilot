...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills and compete in friendly games",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, work on acting skills, and put on performances",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["emma@mergington.edu", "mason@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions and build experimental projects",
